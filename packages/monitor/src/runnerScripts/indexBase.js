...
const ContextTransformer = require('./base');

const ManagerEvents = constants.Manager.Events;
const MonitorEvents = constants.Monitor.Events;

/**
 * This class is the base for all split-context index runners
 *
 ...
 */
class MonitorContextTransformer extends ContextTransformer {
  constructor(contextName) {
    super(contextName);
    // Prevent this class from being instantiated directly as well, a subclass of this should be created
  ...
  /**
   * Start the monitor context transformer
   *
